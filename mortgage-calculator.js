...
// var result = MortgageCalculator.calculateMortgage(options);
...
//   options.salePrice = document.getElementById("userHomePrice").value;
//   options.downPayment = document.getElementById("userDownPayment").value;
